          ...
          <nav className="hidden items-center space-x-8 md:flex flex-1 justify-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="relative">
                ...
                >
                  <div className="w-10 h-10 rounded-full bg-primary/20 purple-glow flex items-center justify-center backdrop-blur-sm border border-primary/20 group-hover:scale-110 group-hover:bg-primary/30 group-hover:border-primary/40 transition-all duration-200">
                    <FaFigma className="h-5 w-5 text-white" />
                  </div>
                </a>
