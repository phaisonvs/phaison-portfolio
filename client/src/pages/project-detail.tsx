...
export default function ProjectDetail() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black text-white">
      ...
      <main className="flex-grow container mx-auto px-4 py-3 pt-16 md:pt-12 pb-20 md:pb-12">
        <Button 
          variant="outline" 
          className="mb-6"
          onClick={() => navigate('/projects')}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4">
            {/* Mobile: Compact floating project info */}
            <div className={`fixed bottom-4 left-4 right-4 bg-zinc-900 rounded-xl p-4 z-50 shadow-2xl border border-zinc-700 lg:hidden transition-all duration-300 ${isShareExpanded ? 'pb-6' : ''}`}>
