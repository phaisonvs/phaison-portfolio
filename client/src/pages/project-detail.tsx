      ...
      <main className="flex-grow container mx-auto px-4 py-6 pt-20 md:pt-12 pb-20 md:pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4">
            {/* Mobile: Fixed bottom sidebar with padding */}
            <div className="fixed bottom-4 left-4 right-4 bg-zinc-900 rounded-xl p-6 z-50 shadow-2xl border border-zinc-700 lg:hidden">
