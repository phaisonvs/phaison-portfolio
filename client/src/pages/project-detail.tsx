      ...
      <main className="flex-grow container mx-auto px-4 py-3 pt-12 md:pt-12 pb-20 md:pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4">
            ...
            {showFloatingInfo && (
              <div className={`fixed bottom-4 left-4 right-4 bg-zinc-900 rounded-xl p-6 z-50 shadow-2xl border border-zinc-700 lg:hidden transition-all duration-500 ease-in-out transform ${showFloatingInfo ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`}>
                <div className="flex items-start space-x-4">
                  ...
                  <button 
                    ...
                    className={`text-gray-400 hover:text-white transition-all duration-300 p-3 flex-shrink-0 ${isShareExpanded ? 'rotate-45' : 'rotate-0'}`}
                  >
                ...
                {/* Expanded Social Media Icons with smooth transition and more spacing */}
                <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isShareExpanded ? 'max-h-40 opacity-100 mt-6' : 'max-h-0 opacity-0 mt-0'}`}>
                  <div className={`pt-6 border-t border-zinc-700 transition-all duration-300 ${isShareExpanded ? 'transform translate-y-0' : 'transform -translate-y-4'}`}>
                    <p className="text-sm text-gray-400 mb-4 text-center">Compartilhar</p>
                    <div className="flex justify-center space-x-8">
                      <button className="text-gray-400 hover:text-white transition-all duration-300 hover:scale-110 p-2">
